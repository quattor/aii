...
use warnings;
use Test::More;
use Test::Quattor qw(kickstart_pre_noblock kickstart_pre_blocksize kickstart_pre_mdstop kickstart_pre_nomdstop kickstart_pre_noaiiblocks);
...
my @tests = qw(noblock blocksize mdstop nomdstop noaiiblocks);
