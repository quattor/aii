...
=item * (Optional) Set ignoremacinterface network interfaces list to avoid to include MAC values within AR/VM templates

=item * (Optional) Set ignoremacaddr list to avoid to include MAC values within AR/VM templates for these MACs
