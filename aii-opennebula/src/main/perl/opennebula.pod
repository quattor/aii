...
This document describes AII's OpenNebula. It must be called from aii-shellfe 2 or higher.

=head1 SYNOPSIS

This AII component generates the required resources and templates to instantiate/create/remove VMs within an OpenNebula infrastructure.
